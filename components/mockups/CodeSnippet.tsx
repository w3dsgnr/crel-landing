...
// Код-сниппет White Label API: type-анимация + две цветовые схемы.
// Решение заказчика (дизайн-проход): код печатает себя при входе в вьюпорт,
// два варианта: терминальная (cyan/зелёный/серый на тёмном) и light v4 (синий/красный/серый на белом).
// Выбор схемы — проп variant; SSR отдаёт полный подсвеченный код, прогон в общей очереди.
