...
// v3: карточки без рамок — заливка --bg-mist и радиус сами рисуют границу.
  ...
  return (
    <section className="bg-bloom">
      <div className="mx-auto max-w-[1200px] px-5 py-28 md:px-12 md:py-40">
        <p className="text-label text-pine-600">{cases.section.label}</p>
        <h2 className="text-h2 mt-6 max-w-[16ch]">{cases.section.title}</h2>
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div
            data-reveal
            className="flex min-h-[320px] flex-col justify-between rounded-(--radius-xl) bg-bg-mist p-8 md:col-span-2 md:p-10"
          >
          ...
          <div className="flex flex-col gap-6">
            {cases.compact.map((c, i) => (
              <div key={i} data-reveal className="flex-1 rounded-(--radius-l) bg-bg-mist p-6">
