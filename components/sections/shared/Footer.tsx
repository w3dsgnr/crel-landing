...
// design.md): плакат в раме. Рама — плоскость финала (.bg-finale): футер
// продолжает плоскость Finale без шва (решение 2026-08-18). Правка 2026-08-19:
// плоскость финала и рама перекрашены из синего #2668d9 в чёрный #0a0a0a
// (анатомия hero), по раме — cursor-grid как в hero (клетки вспыхивают под
// курсором). Внутри — светлая карточка bg-mist со скруглёнными ВЕРХНИМИ
// углами того же радиуса, что низ hero, отступ от рамы по бокам и сверху
// равный, до низа страницы.
...
// Моушна нет, кроме цвета ссылок и cursor-grid: блок — точка покоя после финала.
//
...
export function Footer() {
  ...
  return (
    <footer className="layer-v4 bg-finale relative isolate" style={{ padding: `${INSET} ${INSET} 0` }}>
      {/* cursor-grid как в hero (правка 2026-08-19): на чёрной раме клетки
          вспыхивают под курсором; события — с <footer> (parentElement), слой
          -z-10 внутри isolate — под карточкой, над заливкой рамы */}
      <CursorGrid />
